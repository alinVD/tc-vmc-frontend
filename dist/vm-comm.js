...
var BufferArray = exports.Array = __webpack_require__(33);
var BufferBuffer = exports.Buffer = __webpack_require__(34);
var BufferUint8Array = exports.Uint8Array = __webpack_require__(35);
...
var ExtPacker = __webpack_require__(37);
var WriteType = __webpack_require__(38);
...
var ExtBuffer = __webpack_require__(4).ExtBuffer;
var ExtUnpacker = __webpack_require__(40);
var readUint8 = __webpack_require__(19).readUint8;
var ReadToken = __webpack_require__(41);
var CodecBase = __webpack_require__(1);
...
Object.defineProperty(exports, "__esModule", { value: true });
const misc_1 = __webpack_require__(2);
const _der_1 = __webpack_require__(10);
...
var EncodeBuffer = __webpack_require__(12).EncodeBuffer;
...
var FlexEncoder = __webpack_require__(16).FlexEncoder;
...
var FlexDecoder = __webpack_require__(16).FlexDecoder;
...
Object.defineProperty(exports, "__esModule", { value: true });
const ti_crypto_1 = __webpack_require__(24);
const eventemitter3_1 = __webpack_require__(26);
const msgpack_lite_1 = __webpack_require__(27);
const cipher_1 = __webpack_require__(21);
...
class VMConnection extends eventemitter3_1.EventEmitter {
    constructor(socket, cipher) {
        ...
        socket.onmessage = message => {
            ...
            this.cipher.decryptMessage(encryptedReply).then(decrypted => {
                let reply = msgpack_lite_1.decode(decrypted);
    ...
    send(type, payload) {
        ...
        this.cipher.encryptMessage(msgpack_lite_1.encode(req)).then(sealed => this.socket.send(msgpack_lite_1.encode(sealed).buffer), err => console.log("VM connection encryption error:", err));
...
Object.defineProperty(exports, "__esModule", { value: true });
const misc_1 = __webpack_require__(2);
const aes_1 = __webpack_require__(9);
const _der_1 = __webpack_require__(10);
...
exports.encode = __webpack_require__(11).encode;
exports.decode = __webpack_require__(17).decode;

exports.Encoder = __webpack_require__(42).Encoder;
exports.Decoder = __webpack_require__(43).Decoder;

exports.createCodec = __webpack_require__(44).createCodec;
exports.codec = __webpack_require__(45).codec;
...
function encode(input) {
  if (!_encode) _encode = __webpack_require__(11).encode; // lazy load
...
var Bufferish = __webpack_require__(0);
var BufferProto = __webpack_require__(6);
var WriteToken = __webpack_require__(39);
var uint8 = __webpack_require__(15).uint8;
var ExtBuffer = __webpack_require__(4).ExtBuffer;
...
function decode(input) {
  if (!_decode) _decode = __webpack_require__(17).decode; // lazy load
